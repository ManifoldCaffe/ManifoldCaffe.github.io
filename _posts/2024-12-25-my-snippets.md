...
[
    ...
    {trigger: "AA", replacement: "\\boldsymbol{A}", options: "mA"},
    {trigger: "aa", replacement: "\\boldsymbol{a}", options: "mA"},
    {trigger: "BB", replacement: "\\boldsymbol{B}", options: "mA"},
    {trigger: "bb", replacement: "\\boldsymbol{b}", options: "mA"},
    {trigger: "bXX", replacement: "\\boldsymbol{X}", options: "mA"},
    {trigger: "bxx", replacement: "\\boldsymbol{x}", options: "mA"},
    {trigger: "YY", replacement: "\\boldsymbol{Y}", options: "mA"},
    {trigger: "yy", replacement: "\\boldsymbol{y}", options: "mA"},
    {trigger: "ff", replacement: "\\boldsymbol{f}", options: "mA"},
    {trigger: "EE", replacement: "\\mathbb{E}", options: "mA"},
    {trigger: "(\\\\*[A-Za-z]+)ppp", replacement: "[[0]]_1+[[0]]_2+\\cdots+[[0]]_{${0:n}}$1 ", options: "rm"},
    ...
    {trigger: "nsum", replacement: "\\sum_{${0:i}=1}^{${1:n}} $2", options: "mA", description: "Articulated sum"},
